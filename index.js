...
function flattenArray(arr) {
  ...
  // Використовуємо метод flat з параметром Infinity, щоб "випрямити" масив на будь-яку глибину вкладенос
...
function expandArrayByN(arr, n) {
  ...
  const expandedArray = arr.flatMap((n) => (n === n ? [n, n, n] : n));
...
function findDuplicateElements(arr) {
  ...
  const dublicateElements = arr.filter((num, index) => {
...
function findLastNegativeNumberIndex(arr) {
  ...
  const lastIndex = arr.findLastIndex(findLastNegativeNumberIndex);
